    ...
    <section id='Home' className="pb-[120px] flex items-center justify-center h-screen bg-cover bg-center bg-no-repeat bg-[url('https://media.discordapp.net/attachments/781836268849987605/1147796900687392788/bg.jpg?')] bg-gray-700 bg-blend-multiply">
        <div className=" px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 ">
                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        ...
                        offset={-60}
                        duration={500} 
                        className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg bg-[#FFD800] hover:bg-[#3F4C03] hover:text-white focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                            Order Yours
                        ...
                        offset={-60}
                        duration={500}
                        className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border-2 border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                            About Us
                        </Link>  
                    </div>
        </div>
